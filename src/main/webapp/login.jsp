...
<%@include file="normal_navbar.jsp" %>
	...
	<main class="d-flex align-items-center primary-background banner-background text-white" style="height: 70vh;" >
		<div class="container">
			<div class="row">
							...
							<form>
								...
								<div class="form-check">
									<input type="checkbox" class="form-check-input"
										id="exampleCheck1"> <label class="form-check-label text-dark"
